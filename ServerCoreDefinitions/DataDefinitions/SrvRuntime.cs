...
namespace EasyITCenter.ServerCoreStructure {
    ...
    public partial class SrvRuntime {
        ...
        public static string DistributeLibrary_path { get; set; } = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), SrvConfig.DefaultStaticWebFilesFolder, "distribute-library");
        public static string SrvWebPages_path { get; set; } = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), SrvConfig.DefaultStaticWebFilesFolder, "server-PagesWeb");
        public static string SrvHelpPages_path { get; set; } = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), SrvConfig.DefaultStaticWebFilesFolder, "server-PagesHelp");
        public static string SysPortal_path { get; set; } = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), SrvConfig.DefaultStaticWebFilesFolder, "system-Portal");
