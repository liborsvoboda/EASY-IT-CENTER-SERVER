...
namespace ServerCorePages
{
    public class SecurityModel : PageModel
    {
        ...
        public SecurityModel(UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, ILogger<RazorTemplateModel> logger) 
        {
        ...
        public async Task<IActionResult> OnPostLinkLoginAsync(string provider)
        {
            ...
            var redirectUrl = Url.Page("/DevPortal/Security", pageHandler: "LinkLoginCallback");
