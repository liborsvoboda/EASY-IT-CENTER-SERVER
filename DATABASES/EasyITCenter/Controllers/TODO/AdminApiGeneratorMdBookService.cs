        ...
        public async Task<IActionResult> GenerateInteliMDBook([FromBody] MDDocBookGenerator requestData) {
            ...
            try {
                ...
                if (!requestData.UpdateOnly) {
                    ...
                    FileOperations.CopyDirectory(Path.Combine(SrvRuntime.SrvGeneratorsPath, "Docs", "MdInteliBook"), Path.Combine(SrvRuntime.WebRootPath, requestData.PathName, "MdInteliBook"));
            ...
            try {  WordprocessingDocument? document = null; var styles = new DocumentStyles(); DocxDocumentRenderer? renderer = null; MarkdownPipeline? pipeline = null;
                ...
                indexRootList.ForEach(rootFolder => {
                    ...
                    if (!mdBookPrepared && webFilesRequest.MdBookLibrary) {
                        ...
                        FileOperations.CopyDirectory(Path.Combine(SrvRuntime.SrvGeneratorsPath, "Docs", "MdInteliBook"), SrvRuntime.WebRootPath + FileOperations.ConvertSystemFilePathFromUrl(webFilesRequest.WebRootFilePath) + "MdInteliBook");
                    }
                ...
                if (!processInterrupted && webFilesRequest.CentralIndexOnly) {
                    FileOperations.CopyFiles(Path.Combine(SrvRuntime.SrvGeneratorsPath, "Docs", "MdBrowser"), SrvRuntime.WebRootPath + FileOperations.ConvertSystemFilePathFromUrl(webFilesRequest.WebRootFilePath), webFilesRequest.OveriteExisting);
                }
