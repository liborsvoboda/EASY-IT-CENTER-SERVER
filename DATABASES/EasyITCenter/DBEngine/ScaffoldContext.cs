    ...
    public partial class ScaffoldContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BusinessAddressList>(entity =>
            {
                ...
                entity.HasOne(d => d.SolutionUserRoleList)
                    .WithMany(p => p.BusinessAddressLists)
                    .HasForeignKey(d => d.SolutionUserRoleListId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_BusinessAddressList_SolutionUserRoleList");
            });
            ...
            modelBuilder.Entity<DocSrvDocumentationList>(entity =>
            {
                ...
                entity.HasOne(d => d.DocSrvDocumentationGroupListNameNavigation)
                    .WithMany(p => p.DocSrvDocumentationLists)
                    .HasPrincipalKey(p => p.Name)
                    .HasForeignKey(d => d.DocSrvDocumentationGroupListName)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_DocSrvDocumentationList_DocSrvDocumentationGroupList");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.DocSrvDocumentationLists)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_DocSrvDocumentationList_SolutionUserList");
            });
            ...
            modelBuilder.Entity<ServerStorageVersionFileSupportList>(entity =>
            {
                entity.Property(e => e.TimeStamp).HasDefaultValueSql("(getdate())");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.ServerStorageVersionFileSupportLists)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_ServerStorageVersionList_SolutionUserList");
            });

            modelBuilder.Entity<ServerStorageVersionSettingSupportList>(entity =>
            {
                entity.Property(e => e.TimeStamp).HasDefaultValueSql("(getdate())");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.ServerStorageVersionSettingSupportLists)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_ServerStorageVersionSettingList_SolutionUserList");
            });
