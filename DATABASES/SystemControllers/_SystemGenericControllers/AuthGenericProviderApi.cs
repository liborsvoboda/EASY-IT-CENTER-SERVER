...
namespace EasyITCenter.Controllers {
    ...
    [Route("[controller]")]
    [ApiController]
    public abstract class AuthGenericProviderApi<DbEntity, Tentity, TKey> : ControllerBase where DbEntity : EasyITCenterContext where Tentity : class where TKey : notnull {
        private readonly IGenericApiServiceAsync<DbEntity, Tentity> db;

        public AuthGenericProviderApi(IGenericApiServiceAsync<DbEntity, Tentity> repo) => db = repo;
