...
namespace EasyITCenter.WebControllers {
    ...
    public class StripeGateway : IRestGateway {
        ...
        private HttpRequestMessage PrepareRequest(string relativeUrl, string method, string requestBody, string idempotencyKey) {
            ...
            httpReq.Headers.Add(HttpHeaders.Accept, "application/json");
...
namespace ServiceStack.Stripe.Types {
    ...
    public class StripeProduct : StripeId {
        ...
        public string Url { get; set; }
        //StripePackageDimensions IStripeProduct.PackageDimensions { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
    }
