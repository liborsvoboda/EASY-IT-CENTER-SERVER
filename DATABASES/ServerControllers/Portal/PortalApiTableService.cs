            ...
            try {
                if (HttpContextExtension.IsLogged()) {
                    ...
                    if (original.Count == 5) {//UPDATE only
                        ...
                        List<PortalApiTableColumnDataList> record = new();
                        record.Add(new PortalApiTableColumnDataList() { ApiTableName = "UserSetting", ApiTableColumnName = "EnableAutoTranslate", InheritedDataType = "bit", RecGuid = recGuid, Value = userSetting.EnableAutoTranslate.ToString(), Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new() { ApiTableName = "UserSetting", ApiTableColumnName = "EnableShowDescription", InheritedDataType = "bit", RecGuid = recGuid, Value = userSetting.EnableShowDescription.ToString(), Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new() { ApiTableName = "UserSetting", ApiTableColumnName = "RememberLastJson", InheritedDataType = "bit", RecGuid = recGuid, Value = userSetting.RememberLastJson.ToString(), Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new() { ApiTableName = "UserSetting", ApiTableColumnName = "RememberLastHandleBar", InheritedDataType = "bit", RecGuid = recGuid, Value = userSetting.RememberLastHandleBar.ToString(), Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new() { ApiTableName = "UserSetting", ApiTableColumnName = "EnableScreenSaver", InheritedDataType = "bit", RecGuid = recGuid, Value = userSetting.EnableScreenSaver.ToString(), Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
        ...
        public async Task<string> SetQuestionList([FromBody] QuestionRequest questionRequest) {
            ...
            try {
                ...
                if (checkData != null) {
                    ...
                    record.Add(new() { ApiTableName = "QuestionList", ApiTableColumnName = "Question", InheritedDataType = "string", RecGuid = recGuid, Value = questionRequest.Question, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                    record.Add(new() { ApiTableName = "QuestionList", ApiTableColumnName = "Response", InheritedDataType = "string", RecGuid = recGuid, Value = null, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
            ...
            try {
                ...
                if (checkData != null) {
                    ...
                    if (string.IsNullOrWhiteSpace(emailTemplateRequest.RecGuid)) {
                        string recGuid = Guid.NewGuid().ToString().ToUpper();
                        List<PortalApiTableColumnDataList> record = new();
                        record.Add(new PortalApiTableColumnDataList() { ApiTableName = "EmailTemplateList", ApiTableColumnName = "TemplateName", InheritedDataType = "string", RecGuid = recGuid, Value = emailTemplateRequest.TemplateName, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new() { ApiTableName = "EmailTemplateList", ApiTableColumnName = "HtmlContent", InheritedDataType = "string", RecGuid = recGuid, Value = emailTemplateRequest.HtmlContent, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new() { ApiTableName = "EmailTemplateList", ApiTableColumnName = "JsonContent", InheritedDataType = "string", RecGuid = recGuid, Value = emailTemplateRequest.JsonContent, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new() { ApiTableName = "EmailTemplateList", ApiTableColumnName = "Description", InheritedDataType = "string", RecGuid = recGuid, Value = emailTemplateRequest.Description, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
            ...
            try {
                ...
                if (checkData != null) {
                    ...
                    if (string.IsNullOrWhiteSpace(audioNotepadRequest.RecGuid)) {
                        string recGuid = Guid.NewGuid().ToString().ToUpper();
                        List<PortalApiTableColumnDataList> record = new();
                        record.Add(new PortalApiTableColumnDataList() { ApiTableName = "AudioNotepad", ApiTableColumnName = "Subject", InheritedDataType = "string", RecGuid = recGuid, Value = audioNotepadRequest.Subject, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new() { ApiTableName = "AudioNotepad", ApiTableColumnName = "HtmlContent", InheritedDataType = "string", RecGuid = recGuid, Value = audioNotepadRequest.HtmlContent, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new() { ApiTableName = "AudioNotepad", ApiTableColumnName = "Description", InheritedDataType = "string", RecGuid = recGuid, Value = audioNotepadRequest.Description, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
            ...
            try {
                if (HttpContextExtension.IsLogged()) {
                    ...
                    if (string.IsNullOrWhiteSpace(dataTableRequest.RecGuid)) {
                        string recGuid = Guid.NewGuid().ToString().ToUpper();
                        List<PortalApiTableColumnDataList> record = new();
                        record.Add(new PortalApiTableColumnDataList() { ApiTableName = "DataTableList", ApiTableColumnName = "TableName", InheritedDataType = "string", RecGuid = recGuid, Value = dataTableRequest.TableName, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new() { ApiTableName = "DataTableList", ApiTableColumnName = "ColumnsDef", InheritedDataType = "string", RecGuid = recGuid, Value = dataTableRequest.ColumnsDef, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new() { ApiTableName = "DataTableList", ApiTableColumnName = "Data", InheritedDataType = "string", RecGuid = recGuid, Value = dataTableRequest.Data, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new() { ApiTableName = "DataTableList", ApiTableColumnName = "Description", InheritedDataType = "string", RecGuid = recGuid, Value = dataTableRequest.Description, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
            ...
            try {
                ...
                if (checkData != null) {
                    ...
                    if (string.IsNullOrWhiteSpace(codeGeneratorRequest.RecGuid)) {
                        string recGuid = Guid.NewGuid().ToString().ToUpper();
                        List<PortalApiTableColumnDataList> record = new();
                        record.Add(new PortalApiTableColumnDataList() { ApiTableName = "CodeGeneratorList", ApiTableColumnName = "CodeName", InheritedDataType = "string", RecGuid = recGuid, Value = codeGeneratorRequest.CodeName, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new PortalApiTableColumnDataList() { ApiTableName = "CodeGeneratorList", ApiTableColumnName = "Description", InheritedDataType = "string", RecGuid = recGuid, Value = codeGeneratorRequest.Description, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new() { ApiTableName = "CodeGeneratorList", ApiTableColumnName = "JsonContent", InheritedDataType = "string", RecGuid = recGuid, Value = codeGeneratorRequest.JsonContent, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new() { ApiTableName = "CodeGeneratorList", ApiTableColumnName = "CodeContent", InheritedDataType = "string", RecGuid = recGuid, Value = codeGeneratorRequest.CodeContent, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new() { ApiTableName = "CodeGeneratorList", ApiTableColumnName = "SubCodeContent", InheritedDataType = "string", RecGuid = recGuid, Value = codeGeneratorRequest.SubCodeContent, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
            ...
            try {
                ...
                if (checkData != null) {
                    ...
                    if (string.IsNullOrWhiteSpace(mediaPresentationListRequest.RecGuid)) {
                        string recGuid = Guid.NewGuid().ToString().ToUpper();
                        List<PortalApiTableColumnDataList> record = new();
                        record.Add(new PortalApiTableColumnDataList() { ApiTableName = "MediaPresentationList", ApiTableColumnName = "PresentationName", InheritedDataType = "string", RecGuid = recGuid, Value = mediaPresentationListRequest.PresentationName, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new PortalApiTableColumnDataList() { ApiTableName = "MediaPresentationList", ApiTableColumnName = "Description", InheritedDataType = "string", RecGuid = recGuid, Value = mediaPresentationListRequest.Description, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new PortalApiTableColumnDataList() { ApiTableName = "MediaPresentationList", ApiTableColumnName = "DataContent", InheritedDataType = "string", RecGuid = recGuid, Value = mediaPresentationListRequest.DataContent, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        record.Add(new PortalApiTableColumnDataList() { ApiTableName = "MediaPresentationList", ApiTableColumnName = "Theme", InheritedDataType = "string", RecGuid = recGuid, Value = mediaPresentationListRequest.Theme, Description = null, Active = true, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
            ...
            try {
                ...
                if (checkData != null) {
                    ...
                    string RecGuid = Guid.NewGuid().ToString().ToUpper();
                        ...
                        record.Add(new() { ApiTableName = "FavoritesList", ApiTableColumnName = "MenuNewWindow", InheritedDataType = "bit", RecGuid = RecGuid, Value = addToFavorites.MenuNewWindow.ToString(), Description = null, UserId = (int)HttpContextExtension.GetUserId(), TimeStamp = DateTimeOffset.Now.DateTime });
                        DatabaseContextExtensions.RunTransaction(data, (trans) => {
                            data.PortalApiTableColumnDataLists.AddRange(record);
                            data.SaveChanges();
                            return true;
