...
Dříve Byl Překlad Přes Slovník uložený v Systému, To je nutné  pro Offline Stav, kdy není systém připojen k serveru. také agendy ani formuláře nemusí být jen onlinové, můžou to být samostatné nástroje. Potřebují tedy Offline překlady
