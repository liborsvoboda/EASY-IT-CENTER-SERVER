...
*/
async function SaveUserCapturedVideo (filename) {
...
* @param {string} filename Filename for Saving
*/
async function SavePublicCapturedVideo(filename) {
...
*/
async function DonloadTextFileApi(apiPath, Id = null) {
...
*/
async function DownloadApi (apiPath, jsonData, filename, binary, storageName = null, windowFunction = null, Id = null) {
...
* @return {boolean} return status
*/
async function RunServerPostApi (apiPath, jsonData, storageName, windowFunction = null, Id = null) {
    //windowFunction is Only for window.fnName() NOT window.Gs.XXX.XXX Use for Reload Table
    Gs.Behaviors.ShowPageLoading();
    $.ajax({
        global: false,
...
* @return {boolean} return status
*/
async function RunServerPutApi(apiPath, jsonData, storageName, windowFunction = null, Id = null) {
    //windowFunction is Only for window.fnName() NOT window.Gs.XXX.XXX Use for Reload Table
    Gs.Behaviors.ShowPageLoading();
    $.ajax({
        global: false,
...
* @return {boolean} return status
*/
async function RunServerGetApi(apiPath, storageName, windowFunction = null, Id = null) {
    //windowFunction is Only for window.fnName() NOT window.Gs.XXX.XXX Use for Reload Table
    Gs.Behaviors.ShowPageLoading();
    $.ajax({
        global: false,
...
* @return {boolean} return status
*/
async function RunServerDeleteApi (apiPath, windowFunction = null, Id = null) {
    //windowFunction is Only for window.fnName() NOT window.Gs.XXX.XXX Use for Reload Table
    Gs.Behaviors.ShowPageLoading();
    $.ajax({
        global: false,
...
* @return {boolean} return status
*/
async function RunIndexDbDownloadApi (apiPath, jsonData, filename, binary, storageName = null, windowFunction = null, Id = null) {
    //used for Downloading files
    Gs.Behaviors.ShowPageLoading();
    $.ajax({
        global: false,
...
* @return {boolean} return status
*/
async function RunIndexDbPostApi (apiPath, jsonData, storageName, windowFunction = null, Id = null) {
...
* @return {boolean} return status
*/
async function RunIndexDbPutApi (apiPath, jsonData, storageName, windowFunction = null, Id = null) {
    //windowFunction is Only for window.fnName() NOT window.Gs.XXX.XXX Use for Reload Table
    Gs.Behaviors.ShowPageLoading();
    $.ajax({
        global: false,
...
* @return {boolean} return status
*/
async function RunIndexDbGetApi (apiPath, storageName, windowFunction = null, Id = null) {
    //windowFunction is Only for window.fnName() NOT window.Gs.XXX.XXX Use for Reload Table
    Gs.Behaviors.ShowPageLoading();
    $.ajax({
        global: false,
...
* @return {boolean} return status
*/
async function RunIndexDbDeleteApi (apiPath, windowFunction = null, Id = null) {
    //windowFunction is Only for window.fnName() NOT window.Gs.XXX.XXX Use for Reload Table
    Gs.Behaviors.ShowPageLoading();
    $.ajax({
        global: false,
