 ...
 *Portal StartUp Function
  * @function
 */
async function PortalStartup () { //LOGGED
    ...
    Gs.Variables.getSpProcedure[1].tableName = "SharedMonacoLanguageList";
    Gs.Variables.apiTaskList.push({ UUID: Gs.Functions.GenerateUUID(), Id: Gs.Functions.RandomString(), Sequence: 0, Type: "RunServerPostApi", ApiPath: "DatabaseService/SpProcedure/GetGenericDataListByParams", JsonData: JSON.parse(JSON.stringify(Gs.Variables.getSpProcedure)), StorageName: "SharedMonacoLanguageList" });
    Gs.Variables.getSpProcedure[1].tableName = "SharedMonacoSuggestionList";
    Gs.Variables.getSpProcedure[2].camelCase = true;
    Gs.Variables.apiTaskList.push({ UUID: Gs.Functions.GenerateUUID(), Id: Gs.Functions.RandomString(), Sequence: 0, Type: "RunServerPostApi", ApiPath: "DatabaseService/SpProcedure/GetGenericDataListByParams", JsonData: JSON.parse(JSON.stringify(Gs.Variables.getSpProcedure)), StorageName: "SharedMonacoSuggestionList" } );
 ...
 *Hide Page Loading
  * @function
 */
function HidePageLoading () { Metro.activity.close(Gs.Variables.pageLoader); }
 ...
 *Cancel Google Translation
  * @function
 */
async function CancelTranslation (cancel) {
    if (cancel) {
...
*/
function BeforeSetMenu (htmlContentId) {
...
* @function
*/
function ShowWindowFrameWindowCode (elementId) {
...
*/
function RemoveItemBasket (basketTitle) {
    $("#BasketForm").remove();
...
*/
async function InitStripe (price, productName) {
...
* @param {string}     Basket Product Name
*/
function RunStripe (price, productName) {
...
* @param {string}     Basket Product Name
*/
function DownloadedBasket (basketTitle) {
    $("#BasketForm").remove();
    let dataBasket = Metro.storage.getItem("BasketPriceList", null);
    dataBasket.forEach((item, index) => {
        if (item.Title == basketTitle) { dataBasket.splice(index, 1); }
...
* @function
*/
function ShareReceiveClearChat () {
