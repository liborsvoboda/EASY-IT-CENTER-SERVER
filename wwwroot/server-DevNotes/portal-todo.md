https://github.com/jonmiles/bootstrap-treeview/tree/master

--- 

# EasyITcenter a EasySYSTEMbuilder   
...
#NOVY PORTUP VYTVORENI PORTALU



tento BUDE MIT I HORNI LISTU NASTROJU   - a TOTO JE ZAROVEN I PROJEKT EDITOR = CELE JE TO JEDINY CSHTML 

- pro LOGIN AUTOMATICKY ZALOZIT SLOZKU V USERS a TAM MIT MOZNOST TVORIT
- JINAT VYTVORIT TEMP+CAS_zalozeni a za 24hodin smazat


UVODNI OBRAZOVKA   DLAZDICE   (Prihlaste se/Registrace pro moznost testovani)
- DOKUMENTACE
- PORTAL 
- VYVOJAR
- VYZKOUSEJTE SYSTEM + navod nastaveni - LOGIN bude fungovat

- MODULY EIC = DLAZDICE MODULY A NASTROJE SERVERU - adminapidocs atd
- SABLONY | DOPLNUJICI APLIKACE ESB 
- SDILENE WEB MODULY | VYVOJ - co slouzi jako formulare


- A PAK PANELY METRO, DOKUMENTACE, FRAMEVORKY,....
- DLAZDICE MODULY A NASTROJE SERVERU - adminapidocs atd
- ZVAZIT SUBSERVERY - instalovat je 


udelat souboroveho pruvodce a pravim tlacitkem dat moznost editovat 
s moznosti vytvorit Prostor
s moznosti vytvorit DB - a tam ten prostor prenest
(taby SOUBORY/DB/PROJEKTY)

ten buede mit okno Editor a Dalsi taby/Dokumentace
taby: Editor/Náhled/jeho Dokumentace/+Moznost dalsi 

v Editoru:  Ten si ho nacte a otevre se v iframu   a dle prav TOKENU ho bude moci uložit

JEDNODUCHE RYCHLE SUPER - POUZITI NASTROJU IFRAME
1 SOUBOR DEFINIC FUNKCI/GENERATORU PROVIDERControler.CS

udelat jednoduchy index pro slozky web-provider 
statickym generatorem do dlazdic se screenama - proto vyresit pupetiera aby je naskenoval

STAVOVA LISTA/NEULOZENO/NEPRIHLASENO/ VPRAVO CHAT/MESSAGE/NOVINKY
