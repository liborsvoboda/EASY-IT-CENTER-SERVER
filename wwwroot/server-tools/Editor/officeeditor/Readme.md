# ODT Office Editor Input/Output Commands

You need only Input/Output commands for fully use the Tool

- input command = Input To Editor
````
function startEditing() {}
window.editor.openDocumentFromUrl("fileURL", startEditing());
````


- Output command = Output from Editor
````
editorOptions.saveAssCallback();
````
