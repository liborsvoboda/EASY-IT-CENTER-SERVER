...
- Export HTML Table to More Formats
- 
````
<script type="text/javascript" src="/server-tools/alldocsexport/libs/FileSaver/FileSaver.min.js"></script>
<script type="text/javascript" src="/server-tools/alldocsexport/libs/html2canvas/html2canvas.min.js"></script>
<script type="text/javascript" src="/server-tools/alldocsexport/libs/jsPDF/jspdf.min.js"></script>
<script type="text/javascript" src="/server-tools/alldocsexport/libs/jsPDF-AutoTable/jspdf.plugin.autotable.js"></script>
<script type="text/javascript" src="/server-tools/alldocsexport/tableExport.js"></script>
````
