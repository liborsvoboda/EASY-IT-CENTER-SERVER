const plantuml = (() => {
    const initialize = async (cheerpjPath = "/app/plantuml-wasm") => {
        ...
        await cheerpjRunMain("com.plantuml.wasm.v1.RunInit", `/${cheerpjPath.replaceAll("plantuml.js", "")}/plantuml-core.jar`, `${cheerpjPath.replaceAll("plantuml.js", "") }/`)        
    }
    ...
    const _preloadPlantumlFiles = async (urlBasePathForFiles) => {
        ...
        return await Promise.all([
            fetch(`${urlBasePathForFiles.replaceAll("plantuml.js","")}/plantuml-core.jar.js`),
            fetch(`${urlBasePathForFiles.replaceAll("plantuml.js", "")}/plantuml-core.jar`)
        ])
    }
