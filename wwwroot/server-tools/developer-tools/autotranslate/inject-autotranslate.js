...
injectFile("stylesheet",`${window.location.origin}/server-integrated/dev-tools/inject-scripts/autotranslate/css/metro.min.css`);
injectFile("script",`${window.location.origin}/server-integrated/dev-tools/inject-scripts/autotranslate/js/jquery-3.6.0.min.js`);
injectFile("script",`${window.location.origin}/server-integrated/dev-tools/inject-scripts/autotranslate/js/metro.js`);
