    ...
    function TextEditor(mainContainerElementId, editorOptions) {
        ...
        */
        ...
        function createSession() {
            ...
            session = new ops.Session(window.odfCanvas);
        ...
        this.openDocumentFromUrl = function (docUrl, editorReadyCallback) {
			window.FileName = docUrl.split("/").pop();
            ...
            pendingEditorReadyCallback = function () {
                ...
                if (editorReadyCallback) {
					...
					runtime.registerFile(window.FileName, editor.getByteArray());
                    editorReadyCallback();
                }
            };

            window.odfCanvas.load(docUrl);
        ...
        this.closeDocument = function (callback) {
		 ...
		 /**
         * @name TextEditor#getNodeData
         * @function
         * @return {Node} returned Document Nodes
         */
		this.getNodeData = function(){
			let data = window.odfCanvas.odfContainer();
			return data;
		}
		
		 /**
         * @name TextEditor#getByteArray
         * @function
         * @return {Node} returned Document ByteArray
         */
		this.getByteArray = function(){
			let data = window.odfCanvas.odfContainer();
			let res = data.createByteArray(function (ba) {
                    return callback(ba);
                });
        ...
        this.getDocumentAsByteArray = function (callback) {
            var odfContainer = window.odfCanvas.odfContainer();
        ...
        function init() {
            ...
            window.odfCanvas = new odf.OdfCanvas(canvasElement);
            window.odfCanvas.enableAnnotations(annotationsEnabled, true);

            window.odfCanvas.addListener("statereadychange", createSession);
